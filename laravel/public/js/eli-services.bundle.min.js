...
},{"bluebird":"bluebird"}],2:[function(require,module,exports){
'use strict';
...
var _resourceservice = require('../common/resourceservice');
...
var AssignmentPlayer = function () {
    /**
     * @param {object} config
     */

    function AssignmentPlayer(config) {
        _classCallCheck(this, AssignmentPlayer);

        this.basePath = config.basePath; // '/api'
        this.resourceService = new _resourceservice2.default(config);
    ...
    _createClass(AssignmentPlayer, [{
        key: 'isAuthenticated',
        value: function isAuthenticated() {
            if (this.getToken() || this.getAccount()) return true;
            return false;
        }
        ...
        value: function getToken() {
            if (!this.ecofyToken) {
                this.ecofyToken = _jsCookie2.default.get(COOKIE_NAME);
            }
        ...
        value: function setToken(value) {
            ...
            if (!value) {
                _jsCookie2.default.remove(COOKIE_NAME, COOKIE_OPTIONS);
            } else {
                //$http.defaults.headers.common.Authorization = this.ecofyToken;
                _jsCookie2.default.set(COOKIE_NAME, value, COOKIE_OPTIONS);
            }
        }
        ...
        key: 'setSession',
        value: function setSession(token, account) {
            this.setToken(token);
        ...
        value: function signup(account) {
            var self = this;
            return this.resourceService.doRequest({ method: 'POST', body: JSON.stringify(account) }, 'signup').then(function (response) {
                if (response) {
        ...
        value: function signin(credentials) {
            var self = this;
            return this.resourceService.doRequest({ method: 'POST', body: JSON.stringify(credentials) }, 'signin').then(function (response) {
                if (response) {
                    self.setSession(response.token, response.auth.account);
                    return self.getAccount();
                } else {
        ...
        value: function signout() {
            var self = this;
            return this.resourceService.doRequest({ method: 'POST', headers: { 'Authorization': self.getToken() } }, 'signout')
            /*return $http({
                        method: 'POST',
        ...
        value: function fetchMyAccount() {
            ...
            return _promiseutils2.default.createPromise(function (resolve, reject) {
                ...
                if (self.getToken()) {
                    this.resourceService.doRequest({ method: 'GET', headers: { 'Authorization': self.getToken() } }, 'myaccount')
                    /*$http({
                        method: 'GET',
...
},{"../common/promiseutils":1,"../common/resourceservice":2,"js-cookie":4}],4:[function(require,module,exports){
/*!
 ...
 *
 * @fileoverview
 *  This file includes references to all lib/service
 *
 * @author Young Suk Ahn Park
 * @date 5/6/16
 */

var AuthService = require('./authservice').default;
